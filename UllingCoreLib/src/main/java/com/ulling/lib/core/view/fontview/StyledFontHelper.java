    ...
    public Typeface getTyprFaceFont(String fontName) {
        ...
        if ("bauhausBold.ttf".equals(fontName)) {
            ...
            if (bauhausLightRegular == null) {
                return bauhausLightRegular = Typeface
                    .createFromAsset(mCtx.getAssets(), "bauhausLightRegular.ttf");
            } else {
            ...
            if (bauhausNormal == null) {
                return bauhausNormal = Typeface
                    .createFromAsset(mCtx.getAssets(), "bauhausNormal.ttf");
            } else {
